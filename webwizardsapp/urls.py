...
urlpatterns = [
    ...
    path('api/authors/<int:author_id>/like/', LikePostView.as_view(), name='like_post'),
    path('api/authors/<int:author_id>/liked/', LikedItemsView.as_view(), name='liked-items'),
    path('api/authors/<int:author_id>/posts/<int:post_id>/likes/', LikesView.as_view(), name='post-likes'),
