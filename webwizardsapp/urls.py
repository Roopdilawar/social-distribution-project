...
from .views import LoginAPIView, RegisterView, AuthorsListView, AuthorDetailView, PostsView, DetailPostView, AddCommentView, LikePostView, ListCommentsView, CommentDetailView, GetImageView, GetUserIDView, ListFollowersView, DetailFollower, InboxView, UserBioView, UserProfilePictureView,FriendRequestView,AcceptFollowRequest,AuthorPostsView, LikeCommentView
...
urlpatterns = [
    ...
    path('api/posts/<int:post_id>/comments/<int:comment_id>/like/', LikeCommentView.as_view(), name='like_comment'),
