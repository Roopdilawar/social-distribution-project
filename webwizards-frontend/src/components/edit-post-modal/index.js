...
function EditPost({ isOpen, handleClose, post }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.put(`https://social-distribution-95d43f28bb8f.herokuapp.com/api/authors/${post.id.split('/authors/')[1].split('/')[0]}/posts/${postId}`, editedPostData, config);
